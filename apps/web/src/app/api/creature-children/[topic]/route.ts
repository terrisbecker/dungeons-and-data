...
// Allowlisted proxy to the creature's owned-child endpoints (POST). The list is
// hardcoded so this can never be used to reach an arbitrary API path; the API's
// own guards resolve each child up to its creature and enforce ownership.
